...
"#,
        ...
        html! {
            <div class="fixed inset-0 flex items-center justify-center bg-black/70 backdrop-blur-sm z-50 p-4">
                <pre class="text-red-700 font-mono animate-pulse
                              text-sm sm:text-base md:text-lg lg:text-2xl xl:text-4xl
                              max-w-full overflow-x-auto px-2 text-center">
                    { current }
                </pre>
            </div>
        }
