...
pub fn Hero() -> Html {
    ...
    <h1 class="text-left text-3xl sm:text-4xl font-bold mb-8 tracking-wider">
        { "Hi, I'm " }
        <span class="relative text-red-700 animate-glitch">
            { "[ Omeje Remmy ]" }
        </span>
        <span class="ml-1 animate-blink">{"_"}</span>
                        ...
                        <div class="mt-6">
                            <a
                                ...
                                class="inline-block px-6 py-3 border-2 border-red-700 font-bold uppercase tracking-widest rounded hover:bg-red-700 hover:text-green-100 transition"
                            >
                      ...
                      <div class="mt-8 text-sm text-gray-500 font-mono animate-pulse">
